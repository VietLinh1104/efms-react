...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;CommentResponse&gt;**](CommentResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseCommentResponse } from './api';

const instance: PagedResponseCommentResponse = {
    content,
    page,
    size,
    totalElements,
