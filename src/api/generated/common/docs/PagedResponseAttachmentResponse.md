# PagedResponseAttachmentResponse
...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;AttachmentResponse&gt;**](AttachmentResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseAttachmentResponse } from './api';

const instance: PagedResponseAttachmentResponse = {
    content,
    page,
    size,
    totalElements,
