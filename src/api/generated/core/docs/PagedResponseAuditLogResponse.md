...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;AuditLogResponse&gt;**](AuditLogResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseAuditLogResponse } from './api';

const instance: PagedResponseAuditLogResponse = {
    content,
    page,
    size,
    totalElements,
