...
|------------- | ------------- | -------------|
|[**create1**](#create1) | **POST** /v1/partners | Tạo đối tác mới|
|[**getBalance**](#getbalance) | **GET** /v1/partners/{id}/balance | Số dư công nợ của đối tác|
|[**getById**](#getbyid) | **GET** /v1/partners/{id} | Chi tiết đối tác|
|[**getPartnerInvoices**](#getpartnerinvoices) | **GET** /v1/partners/{id}/invoices | Lịch sử hóa đơn của đối tác|
|[**list1**](#list1) | **GET** /v1/partners | Danh sách đối tác (phân trang)|
|[**toggleActive**](#toggleactive) | **PATCH** /v1/partners/{id}/toggle-active | Bật / tắt đối tác|
|[**update1**](#update1) | **PUT** /v1/partners/{id} | Cập nhật đối tác|
...
# **toggleActive**
> ApiResponsePartnerResponse toggleActive()
