# PagedResponseBankTransactionResponse
...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;BankTransactionResponse&gt;**](BankTransactionResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseBankTransactionResponse } from './api';

const instance: PagedResponseBankTransactionResponse = {
    content,
    page,
    size,
    totalElements,
