...
|------------- | ------------- | -------------|
|[**exportReport**](#exportreport) | **GET** /v1/reports/balance-sheet/export | Xuất các báo cáo ra định dạng Excel / PDF (Stub)|
|[**exportReport1**](#exportreport1) | **GET** /v1/reports/cash-flow/export | Xuất các báo cáo ra định dạng Excel / PDF (Stub)|
|[**exportReport2**](#exportreport2) | **GET** /v1/reports/profit-loss/export | Xuất các báo cáo ra định dạng Excel / PDF (Stub)|
|[**getApAging**](#getapaging) | **GET** /v1/reports/ap-aging | Báo cáo Tuổi nợ Phải Trả (AP Aging)|
|[**getArAging**](#getaraging) | **GET** /v1/reports/ar-aging | Báo cáo Tuổi nợ Phải Thu (AR Aging)|
|[**getBalanceSheet**](#getbalancesheet) | **GET** /v1/reports/balance-sheet | Bảng Cân đối kế toán (Balance Sheet)|
|[**getCashFlow**](#getcashflow) | **GET** /v1/reports/cash-flow | Báo cáo Lưu chuyển tiền tệ (Cash Flow Statement)|
|[**getGeneralLedger**](#getgeneralledger) | **GET** /v1/reports/general-ledger | Sổ cái chi tiết theo tài khoản (Account Ledger)|
|[**getProfitLoss**](#getprofitloss) | **GET** /v1/reports/profit-loss | Báo cáo Kết quả Hoạt động Kinh doanh (Profit &amp; Loss / Income Statement)|
|[**getTrialBalanceReport**](#gettrialbalancereport) | **GET** /v1/reports/trial-balance | Bảng Cân đối tài khoản (Trial Balance)|
