...
|------------- | ------------- | -------------|
|[**create3**](#create3) | **POST** /v1/accounting/accounts | Tạo tài khoản mới|
|[**getBalance2**](#getbalance2) | **GET** /v1/accounting/accounts/{id}/balance | Số dư tài khoản theo kỳ hoặc khoảng ngày|
|[**getById2**](#getbyid2) | **GET** /v1/accounting/accounts/{id} | Chi tiết tài khoản|
|[**list4**](#list4) | **GET** /v1/accounting/accounts | Danh sách tài khoản|
...
|[**update3**](#update3) | **PUT** /v1/accounting/accounts/{id} | Cập nhật tài khoản|

# **create3**
> ApiResponseAccountResponse create3(createAccountRequest)
...
# **list4**
> ApiResponseListAccountResponse list4()
...
# **update3**
> ApiResponseAccountResponse update3(createAccountRequest)
