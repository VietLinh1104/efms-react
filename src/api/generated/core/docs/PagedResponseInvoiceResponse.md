...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;InvoiceResponse&gt;**](InvoiceResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseInvoiceResponse } from './api';

const instance: PagedResponseInvoiceResponse = {
    content,
    page,
    size,
    totalElements,
