...
|------------- | ------------- | -------------|
|[**create3**](#create3) | **POST** /api/v1/finance/bank-transactions | Tạo một giao dịch thủ công trên hệ thống|
|[**delete3**](#delete3) | **DELETE** /api/v1/finance/bank-transactions/{id} | Xoá giao dịch (Chỉ khi CHƯA được đối chiếu - unreconciled)|
|[**getById3**](#getbyid3) | **GET** /api/v1/finance/bank-transactions/{id} | Chi tiết một giao dịch ngân hàng|
|[**importData**](#importdata) | **POST** /api/v1/finance/bank-transactions/import | Import bản sao kê (Bank Statement) từ file CSV/Excel|
|[**list3**](#list3) | **GET** /api/v1/finance/bank-transactions | Danh sách giao dịch ngân hàng|
...
# **getById3**
> ApiResponseBankTransactionResponse getById3()
