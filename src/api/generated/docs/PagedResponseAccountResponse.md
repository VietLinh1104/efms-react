...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;AccountResponse&gt;**](AccountResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseAccountResponse } from './api';

const instance: PagedResponseAccountResponse = {
    content,
    page,
    size,
    totalElements,
