...
|------------- | ------------- | -------------|
|[**create4**](#create4) | **POST** /api/v1/finance/bank-accounts | Tạo tài khoản ngân hàng|
|[**getBalance1**](#getbalance1) | **GET** /api/v1/finance/bank-accounts/{id}/balance | Lấy Số dư tài khoản hiện tại|
|[**getById1**](#getbyid1) | **GET** /api/v1/finance/bank-accounts/{id} | Chi tiết tài khoản ngân hàng|
|[**list4**](#list4) | **GET** /api/v1/finance/bank-accounts | Danh sách tài khoản ngân hàng|
|[**toggleActive2**](#toggleactive2) | **PATCH** /api/v1/finance/bank-accounts/{id}/toggle-active | Bật/Tắt trạng thái hoạt động tài khoản|
|[**update3**](#update3) | **PUT** /api/v1/finance/bank-accounts/{id} | Cập nhật tài khoản ngân hàng|
...
# **toggleActive2**
> ApiResponseBankAccountResponse toggleActive2()
