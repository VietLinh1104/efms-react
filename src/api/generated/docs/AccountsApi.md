...
|------------- | ------------- | -------------|
|[**create7**](#create7) | **POST** /api/v1/accounting/accounts | Tạo tài khoản mới|
|[**getBalance2**](#getbalance2) | **GET** /api/v1/accounting/accounts/{id}/balance | Số dư tài khoản theo kỳ hoặc khoảng ngày|
|[**getById2**](#getbyid2) | **GET** /api/v1/accounting/accounts/{id} | Chi tiết tài khoản|
|[**list7**](#list7) | **GET** /api/v1/accounting/accounts | Danh sách tài khoản|
|[**listPage**](#listpage) | **GET** /api/v1/accounting/accounts/page | Danh sách tài khoản (phân trang)|
|[**toggleActive3**](#toggleactive3) | **PATCH** /api/v1/accounting/accounts/{id}/toggle-active | Bật / tắt trạng thái tài khoản|
|[**update5**](#update5) | **PUT** /api/v1/accounting/accounts/{id} | Cập nhật tài khoản|
...
# **getById2**
> ApiResponseAccountResponse getById2()
...
# **toggleActive3**
> ApiResponseAccountResponse toggleActive3()
...
const { status, data } = await apiInstance.toggleActive3(
    id
);
```
