...
|------------- | ------------- | -------------|
|[**close**](#close) | **POST** /api/v1/accounting/fiscal-periods/{id}/close | Đóng kỳ kế toán|
|[**create6**](#create6) | **POST** /api/v1/accounting/fiscal-periods | Tạo kỳ kế toán mới|
|[**list6**](#list6) | **GET** /api/v1/accounting/fiscal-periods | Danh sách kỳ kế toán|
|[**reopen**](#reopen) | **POST** /api/v1/accounting/fiscal-periods/{id}/reopen | Mở lại kỳ kế toán (Admin)|
