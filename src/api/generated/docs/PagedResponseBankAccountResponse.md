# PagedResponseBankAccountResponse
...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;BankAccountResponse&gt;**](BankAccountResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseBankAccountResponse } from './api';

const instance: PagedResponseBankAccountResponse = {
    content,
    page,
    size,
    totalElements,
