...
|------------- | ------------- | -------------|
|[**cancel1**](#cancel1) | **POST** /api/v1/accounting/journals/{id}/cancel | Huỷ chứng từ|
|[**create5**](#create5) | **POST** /api/v1/accounting/journals | Tạo chứng từ mới (trạng thái draft)|
|[**delete2**](#delete2) | **DELETE** /api/v1/accounting/journals/{id} | Xoá chứng từ (chỉ áp dụng khi ở trạng thái draft)|
|[**getDetail2**](#getdetail2) | **GET** /api/v1/accounting/journals/{id} | Chi tiết chứng từ kèm các dòng bút toán|
|[**list5**](#list5) | **GET** /api/v1/accounting/journals | Danh sách chứng từ (có phân trang, lọc theo trạng thái / ngày)|
|[**post**](#post) | **POST** /api/v1/accounting/journals/{id}/post | Post chứng từ (draft → posted)|
|[**update4**](#update4) | **PUT** /api/v1/accounting/journals/{id} | Cập nhật chứng từ (chỉ áp dụng khi ở trạng thái draft)|
