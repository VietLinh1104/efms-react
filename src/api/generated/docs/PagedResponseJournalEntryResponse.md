...
------------ | ------------- | ------------- | -------------
**content** | [**Array&lt;JournalEntryResponse&gt;**](JournalEntryResponse.md) | Danh sách phần tử | [optional] [default to undefined]
...
```typescript
import { PagedResponseJournalEntryResponse } from './api';

const instance: PagedResponseJournalEntryResponse = {
    content,
    page,
    size,
    totalElements,
