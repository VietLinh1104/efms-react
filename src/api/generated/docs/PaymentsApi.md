...
|------------- | ------------- | -------------|
|[**_delete**](#_delete) | **DELETE** /api/v1/payments/{id} | Xoá hoàn toàn thanh toán (chỉ khi chưa Post GL)|
|[**allocate**](#allocate) | **POST** /api/v1/payments/{id}/allocate | Phân bổ số tiền của payment vào 1 Inovice (AR/AP)|
|[**create**](#create) | **POST** /api/v1/payments | Tạo thanh toán mới|
|[**getDetail**](#getdetail) | **GET** /api/v1/payments/{id} | Chi tiết Phiếu thanh toán kèm các khoản phân bổ|
|[**list**](#list) | **GET** /api/v1/payments | Danh sách phiếu thanh toán (Thu/Chi)|
|[**postPayment**](#postpayment) | **POST** /api/v1/payments/{id}/post | Ghi sổ bút toán tổng hợp (Post payment → GL)|
|[**removeAllocation**](#removeallocation) | **DELETE** /api/v1/payments/{id}/allocate/{invoiceId} | Gỡ / Xóa phân bổ payment vào invoice|
|[**update**](#update) | **PUT** /api/v1/payments/{id} | Cập nhật phiếu thanh toán|
