...
|------------- | ------------- | -------------|
|[**autoMatch**](#automatch) | **POST** /api/v1/finance/reconciliation/auto-match | Tính năng tự động tìm kiếm và Match hàng loạt các GD có Amount trùng và cùng Time|
|[**getPendingMatches**](#getpendingmatches) | **GET** /api/v1/finance/reconciliation | Lấy danh sách các giao dịch NH đang đợi ghép / chờ đối chiếu|
|[**getSummary**](#getsummary) | **GET** /api/v1/finance/reconciliation/summary | Báo cáo Tổng hợp tình trạng Số dư &amp; Giao dịch|
|[**manualMatch**](#manualmatch) | **POST** /api/v1/finance/reconciliation/match | Ghép thủ công 1 GD ngân hàng với 1 Bút toán trên Hệ thống|
|[**unmatch**](#unmatch) | **POST** /api/v1/finance/reconciliation/unmatch/{bankTransactionId} | Gỡ / Xóa link khớp của giao dịch (Un-reconcile)|
